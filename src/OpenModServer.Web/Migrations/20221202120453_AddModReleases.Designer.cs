...
namespace OpenModServer.Web.Migrations
{
    ...
    [Migration("20221202120453_AddModReleases")]
    partial class AddModReleases
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenModServer.Core.Structures.ModListing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OpenModServer.Core.Structures.Releases.Approvals.ModReleaseApprovalChange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OpenModServer.Core.Structures.Releases.ModRelease", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OpenModServer.Web.Identity.OmsUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("OpenModServer.Web.Identity.OmsUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OpenModServer.Core.Structures.Releases.Approvals.ModReleaseApprovalChange", b =>
                {
                    b.HasOne("OpenModServer.Core.Structures.Releases.ModRelease", "ModRelease")
            ...
            modelBuilder.Entity("OpenModServer.Core.Structures.Releases.ModRelease", b =>
                {
                    b.HasOne("OpenModServer.Core.Structures.ModListing", "ModListing")
                        .WithMany()
