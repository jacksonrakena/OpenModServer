...
namespace OpenModServer.Migrations
{
    ...
    [Migration("20221204062158_AddModeratorResponsibleRelationship")]
    partial class AddModeratorResponsibleRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpenModServer.Structures.Releases.Approvals.ModReleaseApprovalChange", b =>
                {
                    ...
                    b.HasOne("OpenModServer.Identity.OmsUser", "ModeratorResponsible")
                        .WithMany()
